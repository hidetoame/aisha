...
export const FacebookIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878V14.89H8.078v-2.89h2.36V9.607c0-2.343 1.393-3.642 3.528-3.642 1.015 0 1.88.075 2.133.109v2.467h-1.45c-1.146 0-1.368.546-1.368 1.345v1.745h2.75l-.356 2.89h-2.394v7.008C18.343 21.128 22 16.991 22 12z"></path>
  </svg>
);
