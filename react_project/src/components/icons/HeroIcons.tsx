...
// Using HeroIcons (outline style generally)
// https://heroicons.com/
...
export const LogoutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m-12.75-3h12.75L12 9" />
  </svg>
);
...
export const RectangleStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 12l4.179 2.25M6.429 14.25l5.571 3 5.571-3M6.429 14.25L2.25 12l4.179 2.25m0 0l5.571 3 5.571-3m0 0l4.179-2.25L12 9.75l-4.179 2.25m11.142 0L12 14.25l-4.179-2.25M21.75 12l-5.571-3-5.571 3M21.75 12l-5.571 3 5.571-3z" />
  </svg>
);

export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h4.5a.75.75 0 01.75.75v7.5m-6-.75h1.5m-1.5 0H5.625c-.621 0-1.125-.504-1.125-1.125v-6.75c0-.621.504-1.125 1.125-1.125H9.75V7.5a3 3 0 016 0v3.75m0 0H9.75m-4.5 0H2.25m19.5 0H18v-3.75a3 3 0 00-3-3H9.75a3 3 0 00-3 3V12m0 0v9" />
  </svg>
);
...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.24.03 3.22.077m3.22-.077L10.875 5.79m.008.008L10.875 5.79m0 0c0-1.097.658-2.022 1.624-2.316C13.437 3.256 14.286 3 15.17 3c1.065 0 2.01.218 2.85.559C19.004 3.92 19.5 4.887 19.5 6c0 .598-.077 1.15-.22 1.659L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.24.03 3.22.077m3.22-.077L10.875 5.79m.008.008L10.875 5.79m0 0c0-1.097.658-2.022 1.624-2.316C13.437 3.256 14.286 3 15.17 3c1.065 0 2.01.218 2.85.559C19.004 3.92 19.5 4.887 19.5 6c0 .598-.077 1.15-.22 1.659" />
  </svg>
);

export const StarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.324h5.372a.562.562 0 01.329.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.652 0l-4.725 2.885a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.329-.988h5.372a.563.563 0 00.475-.324l2.125-5.111z" />
  </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-3.741-5.197m-15 0A3 3 0 013 13.041M3 13.041v2.381C3 17.533 5.433 20 8.959 20S15 17.533 15 14.959V13.04M21 13.041v2.381C21 17.533 18.567 20 15.041 20S9 17.533 9 14.959V13.04M15 13.041c0-1.191.905-2.162 2.008-2.306M5.008 10.735C6.11 10.879 7 11.85 7 13.041M12 6a3 3 0 11-6 0 3 3 0 016 0zm12 0a3 3 0 11-6 0 3 3 0 016 0zM12 10a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);

export const CurrencyDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.553-.44 1.28-.659 2.003-.659.768 0 1.536.219 2.228.659l.879.659m0-2.219l-.879.659c-1.171.879-3.07.879-4.242 0C6.342 8.135 6.342 6.709 7.514 5.83C8.686 4.95 10.324 4.5 12 4.5c1.676 0 3.314.45 4.486 1.33l.879.659m-8.972 5.093c.333.248.694.438 1.079.589M15.352 14.21c-.333-.248-.694-.438-1.079-.589" />
  </svg>
);
...
export const ClipboardDocumentListIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM10.5 16.5h-1.5V12h1.5v4.5z" />
  </svg>
);
...
export const BeakerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6a2.25 2.25 0 00-2.25-2.25H6.319c-.316 0-.622.05-.91.144A2.25 2.25 0 003.22 5.392L2.25 7.5V15a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 15V7.5l-.97-2.108a2.25 2.25 0 00-2.19-1.252C18.002 4.05 17.696 4 17.382 4h-1.872A2.25 2.25 0 0013.26 6.078M2.25 7.5h19.5M9 17.25v2.25M12 17.25v2.25M15 17.25v2.25M9 7.5c0-1.105.152-2.14.426-3.138" />
  </svg>
);
...
export const ThumbUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 18.236V6.764L12.515 2.14A2 2 0 0114 2.418v7.582zM7 21V9m0 12H4m3 0h3" />
  </svg>
);

export const ThumbDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.736 3h4.017c.163 0 .326-.02.485.06L17 5.764V17.236L11.485 21.86A2 2 0 0110 21.582V14zM17 3v12m0-12h3m-3 0h-3" />
  </svg>
);
